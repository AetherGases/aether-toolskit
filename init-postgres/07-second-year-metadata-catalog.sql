...
BEGIN
    ...
    FROM (
        VALUES
            ...
            ('permission_group', 'authorization', 'Permission grouping by enterprise.', 'No additional rule.', 'INTERNO', 'authorization', 'META-FR-002'),
            ...
            ('permission_group_employee', 'authorization', 'N:N association between employee and permission group.', 'Composite primary key (id_employee, id_permission_group).', 'RESTRITO', 'authorization', 'META-FR-002'),
            ...
            ('employee', 'institutional', 'Employee of a customer enterprise.', 'Contains personal data and a credential; access is restricted.', 'RESTRITO', 'registry', 'META-FR-005'),
