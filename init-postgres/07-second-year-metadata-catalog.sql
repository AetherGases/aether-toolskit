...
BEGIN
    ...
    FROM (
        VALUES
            ...
            ('permission_group', 'authorization', 'Permission grouping scoped to one enterprise or global.', 'id_enterprise is optional. Null means a global group usable by employees of any enterprise.', 'INTERNO', 'authorization', 'AUTH-FR-005'),
            ...
            ('employee', 'institutional', 'Employee of a customer enterprise.', 'Belongs to one department and exactly one permission group. Scoped groups must match the department enterprise; global groups are allowed for any employee. Contains personal data and a credential; access is restricted.', 'RESTRITO', 'registry', 'AUTH-FR-002'),
    ...
    FROM (
        VALUES
            ...
            ('employee', 'phone', 'SENSIVEL', 'Employee phone.', 'Optional personal contact data.', 'META-FR-005'),
            ...
            ('employee', 'id_permission_group', 'RESTRITO', 'Employee permission group.', 'Required. N:1 link to a scoped group of the same enterprise as the department, or to a global group.', 'AUTH-FR-003'),
            ('permission_group', 'id_enterprise', 'INTERNO', 'Enterprise owner of the permission group.', 'Optional. Null identifies a global group. Used to filter scoped groups by enterprise.', 'AUTH-FR-005'),
